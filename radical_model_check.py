...
# check for no uvs, easier way to get non manifolds
sel = cmds.ls(sl=True)[0]

nonManifoldVerts = cmds.polyInfo(sel, nmv=True)

uvs = cmds.ls("{x}.uv[*]".format(x=sel))

print sel
print "nonManifold: ", nm
print "uvs: ", uvs

# check for time based anim curves 
pass

# check for history on meshes, curves, etc?
